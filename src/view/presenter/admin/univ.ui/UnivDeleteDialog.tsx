...
import { UnivDeleteDialogUx } from "../univ.ux/UnivDeleteDialogUx";
...
const UnivDeleteDialog: React.FC<UnivDeleteDialogUx> = (ux) => {
...
export default UnivDeleteDialog;
